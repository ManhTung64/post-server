...
export class S3Service {
  ...
  public createParamsUpload = (file: any) => {
    const params = {
  ...
  public UploadOneFile = async (file: any): Promise<string> => {
    ...
    return (
      `https://${this.bucketName}.s3.${process.env.REGION}.amazonaws.com/` +
      params.Key
    );
  };
  public UploadManyFiles = async (
    files: Array<any>,
